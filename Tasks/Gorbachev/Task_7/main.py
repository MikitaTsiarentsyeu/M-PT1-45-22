...
Пользователь должен иметь возможность просматривать товары из определённой категории, добавлять определённое
количество товаров в корзину и делать окончательный заказ.
